...
/**
 * Represents a 2D surface to render text and colored squares on.
 * The size of the canvas is set by the constructor, and then calls
 * can be made to setCellText() and setCellColor() to add items to the canvas.
 */
public class Canvas {
